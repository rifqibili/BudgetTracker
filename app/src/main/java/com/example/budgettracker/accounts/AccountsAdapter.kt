...
class AccountsAdapter(val list: List<AccountsData>, val findNavController: NavController, val viewModel: OperationsViewModel) : RecyclerView.Adapter<AccountsAdapter.ViewHolder>() {
